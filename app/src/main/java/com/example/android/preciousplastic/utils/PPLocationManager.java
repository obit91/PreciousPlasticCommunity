...
public class PPLocationManager extends Service implements LocationListener {
    ...
    public PPLocationManager(Context context) {
    ...
    public Location getLocation() {
        try {
            ...
            isGPSEnabled = locationManager.isProviderEnabled(LocationManager.GPS_PROVIDER) && permissionAllowed;
            isNetworkEnabled = locationManager.isProviderEnabled(LocationManager.NETWORK_PROVIDER) && permissionAllowed;
    ...
    public void onLocationChanged(Location location) {
        Log.i("locationChanged", String.valueOf(location));
    }
    ...
    public void onStatusChanged(String provider, int status, Bundle extras) {
        Log.i("LocationStatusChanged", provider);
    }
